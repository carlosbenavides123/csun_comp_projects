...
HD_PWD='/home/carlos/csun/csun_comp_projects/VHDL/ca_3/ca_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sa_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sa_top.tcl
