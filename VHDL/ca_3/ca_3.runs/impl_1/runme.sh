...
HD_PWD='/home/carlos/csun/csun_comp_projects/VHDL/ca_3/ca_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sa_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sa_top.tcl -notrace
