...
HD_PWD='/home/carlos/csun/csun_comp_projects/VHDL/ca1/ca1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log unknown_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source unknown_top.tcl
