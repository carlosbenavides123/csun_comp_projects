...
HD_PWD='/home/carlos/csun/csun_comp_projects/VHDL/ca1/ca1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log unknown_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source unknown_top.tcl -notrace
