...
HD_PWD='/home/carlos/csun/csun_comp_projects/VHDL/ca4/ca4/ca4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ca4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ca4.tcl
