...
HD_PWD='C:/vhdl_temp/Binary_counter/Binary_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Binary_Counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Binary_Counter.tcl
