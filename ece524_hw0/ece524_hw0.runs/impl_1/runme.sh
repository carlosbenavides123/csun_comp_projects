...
HD_PWD='C:/Users/carlos/csun/csun_comp_projects/ece524_hw0/ece524_hw0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log downscaler.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source downscaler.tcl -notrace
