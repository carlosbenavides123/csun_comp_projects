...
HD_PWD='/home/carlos/csun/ece524_hw0/ece524_hw0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fix_num_cycles.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fix_num_cycles.tcl
