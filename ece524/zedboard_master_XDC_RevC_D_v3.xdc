...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports cntr[0]];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports cntr[1]];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports cntr[2]];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports cntr[3]];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports cntr[4]];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports cntr[5]];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports cntr[6]];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports cntr[7]];  # "LD7"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports rst];  # "BTNC" Chosen Reset Button
set_property PACKAGE_PIN R16 [get_ports pause];  # "BTND"
