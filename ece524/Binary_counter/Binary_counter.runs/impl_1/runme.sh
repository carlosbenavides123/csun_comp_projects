...
HD_PWD='C:/vhdl_temp/Binary_counter/Binary_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Binary_Counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Binary_Counter.tcl -notrace
